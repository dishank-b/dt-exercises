...
class Simulator(gym.Env):
    ...
    def __init__(
        ...
        if self.randomize_maps_on_reset:
            self.map_names = os.listdir("gym_duckietown/maps")
            self.map_names = ['udem1.yaml', 'loop_dyn_duckiebots.yaml', 
                                'udem_spooky.yaml', 'loop_pedestrians.yaml', 
                                'zigzag_dists.yaml', 'loop_obstacles.yaml']
